...
class ContrastiveSplitMLMExecutor(ContrastiveMLMExecutor):
    ...
    def _train_epoch(self, train_dataloader, epoch_idx):
        ...
        for i, batch in tqdm(enumerate(train_dataloader), desc="Train epoch={}".format(
            ...
            z1, z2, predictions_l,  mi_lower_bound = self.model(contra_view1=contra_view1, contra_view2=contra_view2,
            ...
            # print(mean_loss_l)
            # print(byol_loss)
            mean_loss = self.mlm_ratio * mean_loss_l + self.contra_ratio * byol_loss - 0.1 * mi_lower_bound
            # print(mean_loss)
